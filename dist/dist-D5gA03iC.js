...
var dist_exports = /* @__PURE__ */ __exportAll({
	...
	createDisposableDirective: () => createDisposableDirective,
...
function useFetch(url, ...args) {
	...
	watch([refetch, toRef$1(url)], ([refetch]) => refetch && execute(), { deep: true });
	const shell = {
	...
	function setMethod(method) {
		return (payload, payloadType) => {
			if (!isFetching.value) {
				...
				if (isRef(config.payload)) watch([refetch, toRef$1(config.payload)], ([refetch]) => refetch && execute(), { deep: true });
				return {
					...shell,
					then(onFulfilled, onRejected) {
...
function useTitle(newTitle = null, options = {}) {
	...
	const title = toRef$1((_ref = newTitle !== null && newTitle !== void 0 ? newTitle : document === null || document === void 0 ? void 0 : document.title) !== null && _ref !== void 0 ? _ref : null);
...
//#endregion
export { useDisplayMedia as $, camelize as $n, tryOnScopeDispose as $r, usePreferredColorScheme as $t, useBase64 as A, watchIgnorable as Ai, useThrottledRefHistory as An, promiseTimeout as Ar, useMediaControls as At, useColorMode as B, useVModels as Bn, refDefault as Br, useNetwork as Bt, setSSRHandler as C, useToNumber as Ci, useStyleTag as Cn, noop as Cr, useImage as Ct, useAnimate as D, watchAtMost as Di, useTextDirection as Dn, objectOmit as Dr, useLocalStorage as Dt, useActiveElement as E, watchArray as Ei, useTemplateRefsList as En, objectEntries as Er, useKeyModifier as Et, useBrowserLocation as F, watchWithFilter as Fi, useTitle as Fn, reactifyObject as Fr, useMouse as Ft, useCurrentElement as G, useWebSocket as Gn, syncRefs as Gr, usePageLeave as Gt, useCountdown as H, useVirtualList as Hn, refThrottled as Hr, useObjectUrl as Ht, useCached as I, whenever as Ii, useTransition as In, reactiveComputed as Ir, useMouseInElement as It, useDebouncedRefHistory as J, useWindowFocus as Jn, toArray as Jr, usePerformanceObserver as Jt, useCycleList as K, useWebWorker as Kn, throttleFilter as Kr, useParallax as Kt, useClipboard as L, useUrlSearchParams as Ln, reactiveOmit as Lr, useMousePressed as Lt, useBluetooth as M, watchOnce as Mi, useTimeAgoIntl as Mn, pxValue as Mr, useMemoize as Mt, useBreakpoints as N, watchThrottled as Ni, useTimeoutPoll as Nn, rand as Nr, useMemory as Nt, useAsyncQueue as O, watchDebounced as Oi, useTextSelection as On, objectPick as Or, useMagicKeys as Ot, useBroadcastChannel as P, watchTriggerable as Pi, useTimestamp as Pn, reactify as Pr, useMounted as Pt, useDevicesList as Q, bypassFilter as Qn, tryOnMounted as Qr, usePointerSwipe as Qt, useClipboardItems as R, useUserMedia as Rn, reactivePick as Rr, useMutationObserver as Rt, provideSSRWidth as S, useTimeoutFn as Si, useStorageAsync as Sn, makeDestructurable as Sr, useIdle as St, unrefElement as T, useToggle as Ti, useSwipe as Tn, notNullish as Tr, useIntersectionObserver as Tt, useCssSupports as U, useWakeLock as Un, refWithControl as Ur, useOffsetPagination as Ut, useConfirmDialog as V, useVibrate as Vn, refManualReset as Vr, useNow as Vt, useCssVar as W, useWebNotification as Wn, syncRef as Wr, useOnline as Wt, useDeviceOrientation as X, useWindowSize as Xn, tryOnBeforeMount as Xr, usePointer as Xt, useDeviceMotion as Y, useWindowScroll as Yn, toReactive as Yr, usePermission as Yt, useDevicePixelRatio as Z, assert as Zn, tryOnBeforeUnmount as Zr, usePointerLock as Zt, onKeyPressed as _, useInterval as _i, useSorted as _n, increaseWithUnit as _r, useFocusWithin as _t, createReusableTemplate as a, useArrayFind as ai, usePrevious as an, createGlobalState as ar, useElementHover as at, onLongPress as b, useThrottleFn as bi, useStepper as bn, isDef as br, useGamepad as bt, dist_exports as c, useArrayIncludes as ci, useResizeObserver as cn, createSharedComposable as cr, useEventBus as ct, formatTimeAgoIntlParts as d, useArrayReduce as di, useScreenSafeArea as dn, extendRef as dr, useEyeDropper as dt, tryOnUnmounted as ei, usePreferredContrast as en, clamp as er, useDocumentVisibility as et, getSSRHandler as f, useArraySome as fi, useScriptTag as fn, formatDate as fr, useFavicon as ft, onKeyDown as g, useDebounceFn as gi, useShare as gn, identity as gr, useFocus as gt, onElementRemoval as h, useDateFormat as hi, useSessionStorage as hn, hyphenate as hr, useFileSystemAccess as ht, createFetch as i, useArrayFilter as ii, usePreferredReducedTransparency as in, createFilterWrapper as ir, useElementByPoint as it, useBattery as j, watchImmediate as ji, useTimeAgo as jn, provideLocal as jr, useMediaQuery as jt, useAsyncState as k, watchDeep as ki, useTextareaAutosize as kn, pausableFilter as kr, useManualRefHistory as kt, formatTimeAgo as l, useArrayJoin as li, useSSRWidth as ln, createSingletonPromise as lr, useEventListener as lt, onClickOutside as m, useCounter as mi, useScrollLock as mn, hasOwn as mr, useFileDialog as mt, computedAsync as n, useArrayDifference as ni, usePreferredLanguages as nn, containsProp as nr, useDropZone as nt, createTemplatePromise as o, useArrayFindIndex as oi, useRafFn as on, createInjectionState as or, useElementSize as ot, mapGamepadToXbox360Controller as p, useArrayUnique as pi, useScroll as pn, getLifeCycleTarget as pr, useFetch as pt, useDark as q, useWebWorkerFn as qn, timestamp as qr, useParentElement as qt, computedInject as r, useArrayEvery as ri, usePreferredReducedMotion as rn, createEventHook as rr, useElementBounding as rt, createUnrefFn as s, useArrayFindLast as si, useRefHistory as sn, createRef as sr, useElementVisibility as st, cloneFnJSON as t, until as ti, usePreferredDark as tn, computedWithControl as tr, useDraggable as tt, formatTimeAgoIntl as u, useArrayMap as ui, useScreenOrientation as un, debounceFilter as ur, useEventSource as ut, onKeyStroke as v, useIntervalFn as vi, useSpeechRecognition as vn, injectLocal as vr, useFps as vt, transition as w, useToString as wi, useSupported as wn, normalizeDate as wr, useInfiniteScroll as wt, onStartTyping as x, useTimeout as xi, useStorage as xn, isDefined as xr, useGeolocation as xt, onKeyUp as y, useLastChanged as yi, useSpeechSynthesis as yn, invoke as yr, useFullscreen as yt, useCloned as z, useVModel as zn, refDebounced as zr, useNavigatorLanguage as zt };

//# sourceMappingURL=dist-D5gA03iC.js.map
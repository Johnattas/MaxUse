...
(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.MaxComponentsUi = {}, global.Vue));
	...
	function D(t, e, o = !0) {
		...
		if (t) {
			...
			} : w$1(t), s = d.height, a = d.width, u = e.offsetHeight, p = e.offsetWidth, f = e.getBoundingClientRect(), g = $$1(), it = k$4(), lt = h$6(), L, N, ot = "top";
	...
	function I(t, e, o = !0, n = void 0) {
		...
		if (t) {
			let i = t.offsetParent ? {
				width: t.offsetWidth,
				height: t.offsetHeight
			} : w$1(t), l = e.offsetHeight, d = e.getBoundingClientRect(), s = h$6(), a, u, p = n != null ? n : "top";
		...
		getPreset({ name: e = "", preset: t = {}, options: r, params: s, set: i, defaults: a, selector: n }) {
			...
			if (s$13(t) && r.transform !== "strict") {
				let y = e.replace("-directive", ""), m = t, { colorScheme: R, extend: T, css: j } = m, O = v$2(m, [
					...
					"extend",
					"css"
				]), d = T || {}, { colorScheme: M } = d, z = v$2(d, ["colorScheme"]), u = R || {}, { dark: V } = u, L = v$2(u, ["dark"]), g = M || {}, { dark: te } = g, re = v$2(g, ["dark"]), K = s$13(O) ? this._toVariables({ [y]: h$5(h$5({}, O), z) }, r) : {}, A = s$13(L) ? this._toVariables({ [y]: h$5(h$5({}, L), re) }, r) : {}, X = s$13(V) ? this._toVariables({ [y]: h$5(h$5({}, V), te) }, r) : {}, [G, U] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x = A.declarations) != null ? x : "", A.tokens || []], [H, W] = [(p = X.declarations) != null ? p : "", X.tokens || []];
	...
	var S = {
		...
		update(e = {}) {
			let { theme: t } = e;
			t && (this._theme = $(h$5({}, t), { options: h$5(h$5({}, this.defaults.options), t.options) }), this._tokens = b$4.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
		},
		get theme() {
			return this._theme;
		},
		...
		setPreset(e) {
			this._theme = $(h$5({}, this.theme), { preset: e }), this._tokens = b$4.createTokens(e, this.defaults), this.clearLoadedStyleNames(), N.emit("preset:change", e), N.emit("theme:change", this.theme);
		},
		getOptions() {
			return this.options;
		},
		setOptions(e) {
			this._theme = $(h$5({}, this.theme), { options: e }), this.clearLoadedStyleNames(), N.emit("options:change", e), N.emit("theme:change", this.theme);
		},
		getLayerNames() {
	...
	function tryOnMounted(fn) {
		...
		if ((0, vue.getCurrentInstance)() && (0, vue.getCurrentInstance)().components) (0, vue.onMounted)(fn);
		else if (sync) fn();
	...
	function useStyle(css) {
		...
		var isLoaded = (0, vue.ref)(false);
		var cssRef = (0, vue.ref)(css);
		var styleRef = (0, vue.ref)(null);
		...
		var load = function load(_css) {
			...
			stop = (0, vue.watch)(cssRef, function(value) {
	...
	function setup(app, options) {
		var PrimeVue = { config: (0, vue.reactive)(options) };
	...
	function setupConfig(app, PrimeVue) {
		var isThemeChanged = (0, vue.ref)(false);
		...
		/*** Watchers ***/
		var stopConfigWatcher = (0, vue.watch)(PrimeVue.config, function(newValue, oldValue) {
		...
		var stopRippleWatcher = (0, vue.watch)(function() {
		...
		var stopThemeWatcher = (0, vue.watch)(function() {
		...
		var stopUnstyledWatcher = (0, vue.watch)(function() {
	...
	var MaxIcon_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
		__name: "MaxIcon",
		props: {
			icon: {},
			i: {},
		...
		setup(__props) {
			...
			const STORAGE_KEY = (0, vue.computed)(() => "max-icon-" + iconName.value + "-" + size.value);
			(0, vue.watch)(STORAGE_KEY, () => {
	...
	var Grid_default = /* @__PURE__ */ (0, vue.defineComponent)({
		__name: "Grid",
		setup(__props) {
			const attrs = (0, vue.useAttrs)();
			return (_ctx, _cache) => {
				return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({ class: "max-grid-cols" }, (0, vue.unref)(attrs)), [(0, vue.renderSlot)(_ctx.$slots, "default")], 16);
			};
		}
	});
	//#endregion
	...
	var script$20 = {
		...
		methods: {
			...
			_mergeProps: function _mergeProps(fn) {
				...
				return c$27(fn) ? fn.apply(void 0, args) : vue.mergeProps.apply(void 0, args);
			},
			...
			_getPTSelf: function _getPTSelf() {
				...
				return (0, vue.mergeProps)(this._usePT.apply(this, [this._getPT(obj, this.$name)].concat(args)), this._usePT.apply(this, [this.$_attrsPT].concat(args)));
			},
			...
			ptmi: function ptmi() {
				...
				var key = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
				var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
				var attrs = (0, vue.mergeProps)(this.$_attrsWithoutPT, this.ptm(key, params));
	...
	function render$15(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.mergeProps)({
			width: "14",
			height: "14",
			viewBox: "0 0 14 14",
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
		}, _ctx.pti()), _toConsumableArray$7(_cache[0] || (_cache[0] = [(0, vue.createElementVNode)("path", {
	...
	function render$14(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
			"class": _ctx.cx("root"),
			"data-p": $options.dataP
		}, _ctx.ptmi("root")), [(0, vue.renderSlot)(_ctx.$slots, "default", {}, function() {
			return [(0, vue.createTextVNode)((0, vue.toDisplayString)(_ctx.value), 1)];
		})], 16, _hoisted_1$8);
	}
	...
	var script$17 = {
		...
		computed: {
			...
			attrs: function attrs() {
				return (0, vue.mergeProps)(this.asAttrs, this.a11yAttrs, this.getPTOptions("root"));
			},
	...
	function render$13(_ctx, _cache, $props, $setup, $data, $options) {
		var _component_SpinnerIcon = (0, vue.resolveComponent)("SpinnerIcon");
		var _component_Badge = (0, vue.resolveComponent)("Badge");
		var _directive_ripple = (0, vue.resolveDirective)("ripple");
		return !_ctx.asChild ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.resolveDynamicComponent)(_ctx.as), (0, vue.mergeProps)({
			key: 0,
			"class": _ctx.cx("root"),
			"data-p": $options.dataP
		}, $options.attrs), {
			"default": (0, vue.withCtx)(function() {
				return [(0, vue.renderSlot)(_ctx.$slots, "default", {}, function() {
					return [
						_ctx.loading ? (0, vue.renderSlot)(_ctx.$slots, "loadingicon", (0, vue.mergeProps)({
							key: 0,
							"class": [_ctx.cx("loadingIcon"), _ctx.cx("icon")]
						}, _ctx.ptm("loadingIcon")), function() {
							return [_ctx.loadingIcon ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
								key: 0,
								"class": [
									_ctx.cx("loadingIcon"),
									_ctx.cx("icon"),
							...
							}, _ctx.ptm("loadingIcon")), null, 16)) : ((0, vue.openBlock)(), (0, vue.createBlock)(_component_SpinnerIcon, (0, vue.mergeProps)({
								key: 1,
								"class": [_ctx.cx("loadingIcon"), _ctx.cx("icon")],
								spin: ""
							}, _ctx.ptm("loadingIcon")), null, 16, ["class"]))];
						}) : (0, vue.renderSlot)(_ctx.$slots, "icon", (0, vue.mergeProps)({
							key: 1,
							"class": [_ctx.cx("icon")]
						}, _ctx.ptm("icon")), function() {
							return [_ctx.icon ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
								key: 0,
								"class": [
									_ctx.cx("icon"),
									_ctx.icon,
							...
							}, _ctx.ptm("icon")), null, 16, _hoisted_1$7)) : (0, vue.createCommentVNode)("", true)];
						}),
						_ctx.label ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
							key: 2,
							"class": _ctx.cx("label")
						}, _ctx.ptm("label"), { "data-p": $options.dataLabelP }), (0, vue.toDisplayString)(_ctx.label), 17, _hoisted_2$5)) : (0, vue.createCommentVNode)("", true),
						_ctx.badge ? ((0, vue.openBlock)(), (0, vue.createBlock)(_component_Badge, {
							key: 3,
							value: _ctx.badge,
							"class": (0, vue.normalizeClass)(_ctx.badgeClass),
			...
			_: 3
		}, 16, ["class", "data-p"])), [[_directive_ripple]]) : (0, vue.renderSlot)(_ctx.$slots, "default", {
			key: 1,
			"class": (0, vue.normalizeClass)(_ctx.cx("root")),
	...
	var MaxButton_default = /* @__PURE__ */ (0, vue.defineComponent)({
		__name: "MaxButton",
		props: {
			label: {},
			icon: {},
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(script$17), {
					class: (0, vue.normalizeClass)(`max-button ${"icon-pos-" + __props.iconPos} ${buttonClass.value}`),
					label: __props.label,
					icon: __props.icon,
					...
					icon: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "icon", {}, () => [(0, vue.createElementVNode)("div", _hoisted_1$6, [__props.icon || __props.i ? ((0, vue.openBlock)(), (0, vue.createBlock)(MaxIcon_default, {
						key: 0,
						icon: __props.icon ?? __props.i
					}, null, 8, ["icon"])) : (0, vue.createCommentVNode)("", true)])])]),
					loadingicon: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "icon", {}, () => [(0, vue.createElementVNode)("div", _hoisted_2$4, [(0, vue.createVNode)(MaxIcon_default, { icon: "eos-icons:loading" })])])]),
					_: 3
				}, 8, [
					"class",
					"label",
	...
	function render$12(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [(0, vue.renderSlot)(_ctx.$slots, "default")], 16);
	}
	...
	function render$11(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.mergeProps)({
			...
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
		}, _ctx.pti()), _toConsumableArray$5(_cache[0] || (_cache[0] = [(0, vue.createElementVNode)("path", {
	...
	function render$10(_ctx, _cache, $props, $setup, $data, $options) {
		var _component_TimesIcon = (0, vue.resolveComponent)("TimesIcon");
		var _directive_ripple = (0, vue.resolveDirective)("ripple");
		return (0, vue.openBlock)(), (0, vue.createBlock)(vue.Transition, (0, vue.mergeProps)({
			name: "p-message",
			appear: ""
		}, _ctx.ptmi("transition")), {
			"default": (0, vue.withCtx)(function() {
				return [$data.visible ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
					key: 0,
					"class": _ctx.cx("root"),
					role: "alert",
					"aria-live": "assertive",
					"aria-atomic": "true",
					"data-p": $options.dataP
				}, _ctx.ptm("root")), [(0, vue.createElementVNode)("div", (0, vue.mergeProps)({ "class": _ctx.cx("contentWrapper") }, _ctx.ptm("contentWrapper")), [_ctx.$slots.container ? (0, vue.renderSlot)(_ctx.$slots, "container", {
					key: 0,
					closeCallback: $options.close
				}) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
					key: 1,
					"class": _ctx.cx("content"),
					"data-p": $options.dataP
				}, _ctx.ptm("content")), [
					(0, vue.renderSlot)(_ctx.$slots, "icon", { "class": (0, vue.normalizeClass)(_ctx.cx("icon")) }, function() {
						return [((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.resolveDynamicComponent)(_ctx.icon ? "span" : null), (0, vue.mergeProps)({
							"class": [_ctx.cx("icon"), _ctx.icon],
							"data-p": $options.dataP
						}, _ctx.ptm("icon")), null, 16, ["class", "data-p"]))];
					}),
					_ctx.$slots["default"] ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
						key: 0,
						"class": _ctx.cx("text"),
						"data-p": $options.dataP
					}, _ctx.ptm("text")), [(0, vue.renderSlot)(_ctx.$slots, "default")], 16, _hoisted_3$3)) : (0, vue.createCommentVNode)("", true),
					_ctx.closable ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createElementBlock)("button", (0, vue.mergeProps)({
						key: 1,
						...
						"data-p": $options.dataP
					}, _objectSpread$2(_objectSpread$2({}, _ctx.closeButtonProps), _ctx.ptm("closeButton"))), [(0, vue.renderSlot)(_ctx.$slots, "closeicon", {}, function() {
						return [_ctx.closeIcon ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("i", (0, vue.mergeProps)({
							key: 0,
							"class": [_ctx.cx("closeIcon"), _ctx.closeIcon],
							"data-p": $options.dataP
						}, _ctx.ptm("closeIcon")), null, 16, _hoisted_5$2)) : ((0, vue.openBlock)(), (0, vue.createBlock)(_component_TimesIcon, (0, vue.mergeProps)({
							key: 1,
							"class": [_ctx.cx("closeIcon"), _ctx.closeIcon],
							"data-p": $options.dataP
						}, _ctx.ptm("closeIcon")), null, 16, ["class", "data-p"]))];
					})], 16, _hoisted_4$3)), [[_directive_ripple]]) : (0, vue.createCommentVNode)("", true)
				], 16, _hoisted_2$3))], 16)], 16, _hoisted_1$5)) : (0, vue.createCommentVNode)("", true)];
			}),
			_: 3
		}, 16);
	}
	...
	function render$9(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [(0, vue.renderSlot)(_ctx.$slots, "default")], 16);
	}
	...
	function render$8(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({ "class": $options.containerClass }, _ctx.ptmi("root"), { "aria-hidden": "true" }), [(0, vue.renderSlot)(_ctx.$slots, "default")], 16);
	}
	...
	var InputBase_default = /* @__PURE__ */ (0, vue.defineComponent)({
		__name: "InputBase",
		props: {
			value: { default: "" },
			modelValue: {},
		...
		setup(__props) {
			...
			return (_ctx, _cache) => {
				return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(script$15), {
					variant: "on",
					class: (0, vue.normalizeClass)(["max-input", {
						float: (0, vue.unref)(attrs).float !== void 0,
						done: __props.done,
						caution: __props.caution || __props.done === false
					}])
				}, {
					default: (0, vue.withCtx)(() => [
						(0, vue.createVNode)((0, vue.unref)(script$12), null, {
							default: (0, vue.withCtx)(() => [
								__props.icon ?? __props.iconLeft ?? __props.i ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(script$11), { key: 0 }, {
									default: (0, vue.withCtx)(() => [(0, vue.createVNode)(MaxIcon_default, {
								...
								__props.iconRight ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(script$11), { key: 1 }, {
									default: (0, vue.withCtx)(() => [(0, vue.createVNode)(MaxIcon_default, {
						...
						__props.label ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("label", _hoisted_1$4, (0, vue.toDisplayString)(__props.label), 1)) : (0, vue.createCommentVNode)("", true),
						message.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(script$14), {
							key: 1,
							size: "small",
							class: (0, vue.normalizeClass)(`input-message ${__props.done === false ? "error" : ""}`),
							variant: "simple"
						}, {
							icon: (0, vue.withCtx)(() => [__props.iconMessage ? ((0, vue.openBlock)(), (0, vue.createBlock)(MaxIcon_default, {
								key: 0,
								icon: __props.iconMessage,
								size: .9
							}, null, 8, ["icon"])) : (0, vue.createCommentVNode)("", true)]),
							default: (0, vue.withCtx)(() => [(0, vue.createTextVNode)(" " + (0, vue.toDisplayString)(message.value), 1)]),
							_: 1
						}, 8, ["class"])) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_2$2)),
						__props.done ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_3$2, [(0, vue.createVNode)(MaxIcon_default, {
							icon: "lets-icons:check-fill",
							size: .9
						})])) : __props.required ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_4$2, "*")) : (0, vue.createCommentVNode)("", true)
					]),
					_: 3
				}, 8, ["class"]);
			};
	...
	var script$9 = {
		...
		computed: {
			attrs: function attrs() {
				return (0, vue.mergeProps)(this.ptmi("root", { context: {
					filled: this.$filled,
					disabled: this.disabled
				} }), this.formField);
			},
	...
	var MaxInputText_default = /* @__PURE__ */ (0, vue.defineComponent)({
		__name: "MaxInputText",
		props: {
			modelValue: { default: "" },
			icon: {},
		...
		setup(__props, { emit: __emit }) {
			...
			const caution = (0, vue.computed)(() => props.caution !== void 0 ? props.caution && isDone.value === false : isDone.value === false);
			const error_msg = (0, vue.computed)(() => {
			...
			const emit = __emit;
			(0, vue.watch)(temp_value, () => {
				isDone.value = testIsDone();
				emit("update:modelValue", temp_value.value);
			});
			(0, vue.watch)(() => props.modelValue, () => temp_value.value = props.modelValue);
			return (_ctx, _cache) => {
				return (0, vue.openBlock)(), (0, vue.createBlock)(InputBase_default, (0, vue.mergeProps)(props, {
					value: temp_value.value,
					done: isDone.value,
					error: error_msg.value,
					caution: caution.value
				}), {
					default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(script$9), {
						type: "text",
	...
	function render$6(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.mergeProps)({
			...
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
		}, _ctx.pti()), _toConsumableArray$4(_cache[0] || (_cache[0] = [(0, vue.createElementVNode)("rect", {
			width: "1",
			height: "1",
			fill: "currentColor",
			"fill-opacity": "0"
	...
	function render$5(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.mergeProps)({
			...
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
		}, _ctx.pti()), _toConsumableArray$3(_cache[0] || (_cache[0] = [(0, vue.createElementVNode)("path", {
	...
	function render$4(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.mergeProps)({
			...
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
		}, _ctx.pti()), _toConsumableArray$2(_cache[0] || (_cache[0] = [(0, vue.createElementVNode)("path", {
	...
	function render$3(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", (0, vue.mergeProps)({
			...
			fill: "none",
			xmlns: "http://www.w3.org/2000/svg"
		}, _ctx.pti()), _toConsumableArray$1(_cache[0] || (_cache[0] = [(0, vue.createElementVNode)("path", {
			"fill-rule": "evenodd",
			"clip-rule": "evenodd",
	...
	function render$2(_ctx, _cache, $props, $setup, $data, $options) {
		return $options.inline ? (0, vue.renderSlot)(_ctx.$slots, "default", { key: 0 }) : $data.mounted ? ((0, vue.openBlock)(), (0, vue.createBlock)(vue.Teleport, {
			key: 1,
			to: $props.appendTo
		}, [(0, vue.renderSlot)(_ctx.$slots, "default")], 8, ["to"])) : (0, vue.createCommentVNode)("", true);
	}
	...
	function render$1(_ctx, _cache, $props, $setup, $data, $options) {
		var _component_SpinnerIcon = (0, vue.resolveComponent)("SpinnerIcon");
		return !_ctx.disabled ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
			key: 0,
			...
			(0, vue.renderSlot)(_ctx.$slots, "content", {
				...
				return [(0, vue.createElementVNode)("div", (0, vue.mergeProps)({
					ref: $options.contentRef,
					"class": $options.contentClass,
					style: $data.contentStyle
				}, _ctx.ptm("content")), [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($options.loadedItems, function(item, index) {
					return (0, vue.renderSlot)(_ctx.$slots, "item", {
						key: index,
						item,
			...
			_ctx.showSpacer ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
				key: 0,
				"class": "p-virtualscroller-spacer",
				style: $data.spacerStyle
			}, _ctx.ptm("spacer")), null, 16)) : (0, vue.createCommentVNode)("", true),
			!_ctx.loaderDisabled && _ctx.showLoader && $data.d_loading ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
				key: 1,
				"class": $options.loaderClass
			}, _ctx.ptm("loader")), [_ctx.$slots && _ctx.$slots.loader ? ((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, { key: 0 }, (0, vue.renderList)($data.loaderArr, function(_, index) {
				return (0, vue.renderSlot)(_ctx.$slots, "loader", {
					key: index,
					options: $options.getLoaderOptions(index, $options.isBoth() && { numCols: _ctx.d_numItemsInViewport.cols })
				});
			}), 128)) : (0, vue.createCommentVNode)("", true), (0, vue.renderSlot)(_ctx.$slots, "loadingicon", {}, function() {
				return [(0, vue.createVNode)(_component_SpinnerIcon, (0, vue.mergeProps)({
					spin: "",
					"class": "p-virtualscroller-loading-icon"
				}, _ctx.ptm("loadingIcon")), null, 16)];
			})], 16)) : (0, vue.createCommentVNode)("", true)
		], 16, _hoisted_1$2)) : ((0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: 1 }, [(0, vue.renderSlot)(_ctx.$slots, "default"), (0, vue.renderSlot)(_ctx.$slots, "content", {
			items: _ctx.items,
			rows: _ctx.items,
			columns: $options.loadedColumns
		})], 64));
	...
	function render(_ctx, _cache, $props, $setup, $data, $options) {
		var _component_SpinnerIcon = (0, vue.resolveComponent)("SpinnerIcon");
		var _component_InputText = (0, vue.resolveComponent)("InputText");
		var _component_SearchIcon = (0, vue.resolveComponent)("SearchIcon");
		var _component_InputIcon = (0, vue.resolveComponent)("InputIcon");
		var _component_IconField = (0, vue.resolveComponent)("IconField");
		var _component_CheckIcon = (0, vue.resolveComponent)("CheckIcon");
		var _component_BlankIcon = (0, vue.resolveComponent)("BlankIcon");
		var _component_VirtualScroller = (0, vue.resolveComponent)("VirtualScroller");
		var _component_Portal = (0, vue.resolveComponent)("Portal");
		var _directive_ripple = (0, vue.resolveDirective)("ripple");
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
			...
			_ctx.editable ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("input", (0, vue.mergeProps)({
				key: 0,
				ref: "focusInput",
				name: _ctx.name,
			...
			}, _ctx.ptm("label")), null, 16, _hoisted_2$1)) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
				key: 1,
				ref: "focusInput",
				name: _ctx.name,
				id: _ctx.labelId || _ctx.inputId,
				...
				"data-p": $options.labelDataP
			}, _ctx.ptm("label")), [(0, vue.renderSlot)(_ctx.$slots, "value", {
				value: _ctx.d_value,
				placeholder: _ctx.placeholder
			}, function() {
				var _$options$label;
				return [(0, vue.createTextVNode)((0, vue.toDisplayString)($options.label === "p-emptylabel" ? "\xA0" : (_$options$label = $options.label) !== null && _$options$label !== void 0 ? _$options$label : "empty"), 1)];
			})], 16, _hoisted_3$1)),
			$options.isClearIconVisible ? (0, vue.renderSlot)(_ctx.$slots, "clearicon", {
				key: 2,
				"class": (0, vue.normalizeClass)(_ctx.cx("clearIcon")),
				clearCallback: $options.onClearClick
			}, function() {
				return [((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.resolveDynamicComponent)(_ctx.clearIcon ? "i" : "TimesIcon"), (0, vue.mergeProps)({
					ref: "clearIcon",
					"class": [_ctx.cx("clearIcon"), _ctx.clearIcon],
					onClick: $options.onClearClick
				}, _ctx.ptm("clearIcon"), { "data-pc-section": "clearicon" }), null, 16, ["class", "onClick"]))];
			}) : (0, vue.createCommentVNode)("", true),
			(0, vue.createElementVNode)("div", (0, vue.mergeProps)({ "class": _ctx.cx("dropdown") }, _ctx.ptm("dropdown")), [_ctx.loading ? (0, vue.renderSlot)(_ctx.$slots, "loadingicon", {
				key: 0,
				"class": (0, vue.normalizeClass)(_ctx.cx("loadingIcon"))
			}, function() {
				return [_ctx.loadingIcon ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
					key: 0,
					"class": [
			...
			}) : (0, vue.renderSlot)(_ctx.$slots, "dropdownicon", {
				key: 1,
				"class": (0, vue.normalizeClass)(_ctx.cx("dropdownIcon"))
			}, function() {
				return [((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.resolveDynamicComponent)(_ctx.dropdownIcon ? "span" : "ChevronDownIcon"), (0, vue.mergeProps)({
					"class": [_ctx.cx("dropdownIcon"), _ctx.dropdownIcon],
					"aria-hidden": "true",
					"data-p": $options.dropdownIconDataP
				}, _ctx.ptm("dropdownIcon")), null, 16, ["class", "data-p"]))];
			})], 16),
			(0, vue.createVNode)(_component_Portal, { appendTo: _ctx.appendTo }, {
				"default": (0, vue.withCtx)(function() {
					return [(0, vue.createVNode)(vue.Transition, (0, vue.mergeProps)({
						...
						"default": (0, vue.withCtx)(function() {
							return [$data.overlayVisible ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
								key: 0,
								...
								(0, vue.createElementVNode)("span", (0, vue.mergeProps)({
								...
								_ctx.filter ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
									key: 0,
									"class": _ctx.cx("header")
								}, _ctx.ptm("header")), [(0, vue.createVNode)(_component_IconField, {
									unstyled: _ctx.unstyled,
									pt: _ctx.ptm("pcFilterContainer")
								}, {
									"default": (0, vue.withCtx)(function() {
										return [(0, vue.createVNode)(_component_InputText, {
											ref: "filterInput",
											type: "text",
											value: $data.filterValue,
											onVnodeMounted: $options.onFilterUpdated,
											onVnodeUpdated: $options.onFilterUpdated,
											"class": (0, vue.normalizeClass)(_ctx.cx("pcFilter")),
											...
											"onInput",
											"pt"
										]), (0, vue.createVNode)(_component_InputIcon, {
											unstyled: _ctx.unstyled,
											pt: _ctx.ptm("pcFilterIconContainer")
										}, {
											"default": (0, vue.withCtx)(function() {
												return [(0, vue.renderSlot)(_ctx.$slots, "filtericon", {}, function() {
													return [_ctx.filterIcon ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
														key: 0,
														"class": _ctx.filterIcon
													}, _ctx.ptm("filterIcon")), null, 16)) : ((0, vue.openBlock)(), (0, vue.createBlock)(_component_SearchIcon, (0, vue.normalizeProps)((0, vue.mergeProps)({ key: 1 }, _ctx.ptm("filterIcon"))), null, 16))];
												})];
											}),
											_: 3
										}, 8, ["unstyled", "pt"])];
									...
									_: 3
								}, 8, ["unstyled", "pt"]), (0, vue.createElementVNode)("span", (0, vue.mergeProps)({
									role: "status",
									"aria-live": "polite",
									"class": "p-hidden-accessible"
								}, _ctx.ptm("hiddenFilterResult"), { "data-p-hidden-accessible": true }), (0, vue.toDisplayString)($options.filterResultMessageText), 17)], 16)) : (0, vue.createCommentVNode)("", true),
								(0, vue.createElementVNode)("div", (0, vue.mergeProps)({
									"class": _ctx.cx("listContainer"),
									style: { "max-height": $options.virtualScrollerDisabled ? _ctx.scrollHeight : "" }
								}, _ctx.ptm("listContainer")), [(0, vue.createVNode)(_component_VirtualScroller, (0, vue.mergeProps)({ ref: $options.virtualScrollerRef }, _ctx.virtualScrollerOptions, {
									...
									content: (0, vue.withCtx)(function(_ref) {
										...
										return [(0, vue.createElementVNode)("ul", (0, vue.mergeProps)({
											ref: function ref(el) {
											...
											style: contentStyle,
											role: "listbox"
										}, _ctx.ptm("list")), [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(items, function(option, i) {
											return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: $options.getOptionRenderKey(option, $options.getOptionIndex(i, getItemOptions)) }, [$options.isOptionGroup(option) ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("li", (0, vue.mergeProps)({
												key: 0,
												id: _ctx.$id + "_" + $options.getOptionIndex(i, getItemOptions),
												style: { height: itemSize ? itemSize + "px" : void 0 },
												"class": _ctx.cx("optionGroup"),
												role: "option"
											}, { ref_for: true }, _ctx.ptm("optionGroup")), [(0, vue.renderSlot)(_ctx.$slots, "optiongroup", {
												option: option.optionGroup,
												index: $options.getOptionIndex(i, getItemOptions)
											}, function() {
												return [(0, vue.createElementVNode)("span", (0, vue.mergeProps)({ "class": _ctx.cx("optionGroupLabel") }, { ref_for: true }, _ctx.ptm("optionGroupLabel")), (0, vue.toDisplayString)($options.getOptionGroupLabel(option.optionGroup)), 17)];
											})], 16, _hoisted_6$1)) : (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createElementBlock)("li", (0, vue.mergeProps)({
												key: 1,
												id: _ctx.$id + "_" + $options.getOptionIndex(i, getItemOptions),
												...
												onClick: _cache[8] || (_cache[8] = (0, vue.withModifiers)(function() {}, ["stop"])),
												"data-p-selected": !_ctx.checkmark && $options.isSelected(option),
												"data-p-focused": $data.focusedOptionIndex === $options.getOptionIndex(i, getItemOptions),
												"data-p-disabled": $options.isOptionDisabled(option)
											}, { ref_for: true }, $options.getPTItemOptions(option, getItemOptions, i, "option")), [_ctx.checkmark ? ((0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: 0 }, [$options.isSelected(option) ? ((0, vue.openBlock)(), (0, vue.createBlock)(_component_CheckIcon, (0, vue.mergeProps)({
												key: 0,
												"class": _ctx.cx("optionCheckIcon")
											}, { ref_for: true }, _ctx.ptm("optionCheckIcon")), null, 16, ["class"])) : ((0, vue.openBlock)(), (0, vue.createBlock)(_component_BlankIcon, (0, vue.mergeProps)({
												key: 1,
												"class": _ctx.cx("optionBlankIcon")
											}, { ref_for: true }, _ctx.ptm("optionBlankIcon")), null, 16, ["class"]))], 64)) : (0, vue.createCommentVNode)("", true), (0, vue.renderSlot)(_ctx.$slots, "option", {
												option,
												selected: $options.isSelected(option),
												index: $options.getOptionIndex(i, getItemOptions)
											}, function() {
												return [(0, vue.createElementVNode)("span", (0, vue.mergeProps)({ "class": _ctx.cx("optionLabel") }, { ref_for: true }, _ctx.ptm("optionLabel")), (0, vue.toDisplayString)($options.getOptionLabel(option)), 17)];
											})], 16, _hoisted_7$1)), [[_directive_ripple]])], 64);
										}), 128)), $data.filterValue && (!items || items && items.length === 0) ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("li", (0, vue.mergeProps)({
											key: 0,
											"class": _ctx.cx("emptyMessage"),
											role: "option"
										}, _ctx.ptm("emptyMessage"), { "data-p-hidden-accessible": true }), [(0, vue.renderSlot)(_ctx.$slots, "emptyfilter", {}, function() {
											return [(0, vue.createTextVNode)((0, vue.toDisplayString)($options.emptyFilterMessageText), 1)];
										})], 16)) : !_ctx.options || _ctx.options && _ctx.options.length === 0 ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("li", (0, vue.mergeProps)({
											key: 1,
											"class": _ctx.cx("emptyMessage"),
											role: "option"
										}, _ctx.ptm("emptyMessage"), { "data-p-hidden-accessible": true }), [(0, vue.renderSlot)(_ctx.$slots, "empty", {}, function() {
											return [(0, vue.createTextVNode)((0, vue.toDisplayString)($options.emptyMessageText), 1)];
										})], 16)) : (0, vue.createCommentVNode)("", true)], 16, _hoisted_5$1)];
									}),
									_: 2
								}, [_ctx.$slots.loader ? {
									name: "loader",
									fn: (0, vue.withCtx)(function(_ref2) {
										var options = _ref2.options;
										return [(0, vue.renderSlot)(_ctx.$slots, "loader", { options })];
									}),
									key: "0"
								} : void 0]), 1040, [
									"items",
								...
								!_ctx.options || _ctx.options && _ctx.options.length === 0 ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", (0, vue.mergeProps)({
									key: 1,
									role: "status",
									"aria-live": "polite",
									"class": "p-hidden-accessible"
								}, _ctx.ptm("hiddenEmptyMessage"), { "data-p-hidden-accessible": true }), (0, vue.toDisplayString)($options.emptyMessageText), 17)) : (0, vue.createCommentVNode)("", true),
								(0, vue.createElementVNode)("span", (0, vue.mergeProps)({
									role: "status",
									"aria-live": "polite",
									"class": "p-hidden-accessible"
								}, _ctx.ptm("hiddenSelectedMessage"), { "data-p-hidden-accessible": true }), (0, vue.toDisplayString)($options.selectedMessageText), 17),
								(0, vue.createElementVNode)("span", (0, vue.mergeProps)({
							...
							], 16, _hoisted_4$1)) : (0, vue.createCommentVNode)("", true)];
						}),
						_: 3
					}, 16, [
						"onEnter",
	...
	*/
	...
	var MaxPhoneField_default = /* @__PURE__ */ (0, vue.defineComponent)({
		...
		setup(__props, { emit: __emit }) {
			const props = __props;
			const country_ddi_flags = (0, vue.shallowRef)([
				{
					ddi: 93,
					name: "Afeganistão",
					label: "Afeganistão",
			...
			const country = (0, vue.ref)({
				value: 55,
				sigla: "br"
			});
			const phone = (0, vue.ref)("");
			const noMask = refAutoReset(false, 50);
			const onFocus = (0, vue.ref)(false);
			(0, vue.watch)(phone, () => {
				if (phone.value.length > 0 && phone.value[0] === "0") phone.value = phone.value.substring(1);
			});
			const { ctrl, v } = useMagicKeys();
			(0, vue.watch)(() => [ctrl.value, v.value], () => noMask.value = ctrl.value && v.value && onFocus.value);
			const item_selected = (0, vue.computed)(() => country_ddi_flags.value.find((item) => item.value === country.value.value) ?? null);
			...
			const temp_value = (0, vue.computed)(() => country.value.value + phone.value.replace(/[^0-9]/g, ""));
			const emit = __emit;
			const only_numbers = (0, vue.computed)(() => String(temp_value.value).replace(/[^0-9]/g, ""));
			watchDebounced(temp_value, () => {
				if (temp_value.value !== props.modelValue) emit("update:modelValue", temp_value.value);
			}, { debounce: 500 });
			const maskValue = (0, vue.computed)(() => {
				const tokens = {
					"#": { pattern: /[0-9]/ },
					$: {
						pattern: /[0-9]/,
			...
			return (_ctx, _cache) => {
				const _directive_maska = (0, vue.resolveDirective)("maska");
				return (0, vue.openBlock)(), (0, vue.createBlock)(InputBase_default, (0, vue.mergeProps)({ class: "input-phone" }, props, {
					value: temp_value.value,
					done: __props.done,
					error: __props.error,
					...
					default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", _hoisted_1, [(0, vue.createVNode)((0, vue.unref)(script), {
						...
						option: (0, vue.withCtx)((slotProps) => [(0, vue.renderSlot)(_ctx.$slots, "option", {
							...
							(0, vue.createElementVNode)("div", _hoisted_4, [(0, vue.createElementVNode)("div", {
							...
							slotProps.option["img"] ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("img", {
								key: 0,
								src: `/media/images/${slotProps.option["img"]}`,
								alt: "Image",
								class: "img-label"
							}, null, 8, _hoisted_7)) : (0, vue.createCommentVNode)("", true)
						])])]),
						value: (0, vue.withCtx)((value) => [(0, vue.createElementVNode)("div", _hoisted_8, [(0, vue.createElementVNode)("div", _hoisted_9, [(0, vue.createElementVNode)("img", {
							src: "https://flagcdn.com/w40/" + value.value.sigla.toLowerCase() + ".png",
							alt: "bandeira",
							flex: ""
						}, null, 8, _hoisted_10)]), (0, vue.createElementVNode)("div", _hoisted_11, "+ " + (0, vue.toDisplayString)(value.value.value), 1)])]),
						_: 3
					}, 8, ["modelValue", "options"]), (0, vue.withDirectives)((0, vue.createVNode)((0, vue.unref)(script$9), {
						type: "text",
						"slot-b": "",
	...
	//#endregion
	exports.Botao = MaxButton_default;
	exports.Button = MaxButton_default;
	exports.Grid = Grid_default;
	exports.InputField = MaxInputText_default;
	exports.InputPhone = MaxPhoneField_default;
	exports.InputText = MaxInputText_default;
	exports.MaxButton = MaxButton_default;
	exports.MaxComponentsUiResolver = MaxComponentsUiResolver;
	exports.MaxIcon = MaxIcon_default;
	exports.MaxInputText = MaxInputText_default;
	exports.MaxPhoneField = MaxPhoneField_default;
	exports.PhoneField = MaxPhoneField_default;

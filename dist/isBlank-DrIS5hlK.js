...
*/
function hasContentFn(value, if_zero = false) {
...
function hasContent(value, if_zero = false) {
	return hasContentFn(value, if_zero);
}
//#endregion
...
function blank(value, if_zero = false) {
	return !hasContentFn(value, if_zero);
}
//#endregion
export { hasContentFn as i, isBlank as n, hasContent as r, blank as t };

//# sourceMappingURL=isBlank-DrIS5hlK.js.map